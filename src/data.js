...
export const FURNITURE_CATALOG = [
  ...
  { id: 'diningSet4', cat: '가구', name: '4인 식탁 세트', kind: 'diningSet', seats: 4, w: 1400, d: 1500, h: 750, color: '#b89a74', chairColor: '#d6d0c6' },
  { id: 'diningSet6', cat: '가구', name: '6인 식탁 세트', kind: 'diningSet', seats: 6, w: 2000, d: 1500, h: 750, color: '#a98e6b', chairColor: '#d6d0c6' },
  { id: 'chair',   cat: '가구', name: '의자',         kind: 'chair',    w: 480,  d: 520,  h: 900,  color: '#8d8d8d' },
  { id: 'tvstand', cat: '가구', name: 'TV다이(거실장)', kind: 'tvstand', w: 1800, d: 420,  h: 450,  color: '#f1efe9' },
